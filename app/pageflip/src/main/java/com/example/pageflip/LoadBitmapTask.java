...
public final class LoadBitmapTask implements Runnable {
    ...
    private LoadBitmapTask(Context context) {
        ...
        mPortraitBGs = new int[][] {
                new int[] {R.drawable.screenshot, R.drawable.screenshot, R.drawable.screenshot,
                        R.drawable.screenshot, R.drawable.screenshot, R.drawable.screenshot,
                        R.drawable.screenshot, R.drawable.screenshot, R.drawable.screenshot,
                        R.drawable.p10_1080},
                new int[] {R.drawable.screenshot, R.drawable.screenshot, R.drawable.screenshot,
                        R.drawable.screenshot, R.drawable.screenshot, R.drawable.screenshot,
                        R.drawable.screenshot, R.drawable.screenshot, R.drawable.screenshot,
                        R.drawable.p10_1080},
                new int[] {R.drawable.screenshot, R.drawable.screenshot,
                        R.drawable.screenshot, R.drawable.screenshot,
                        R.drawable.screenshot, R.drawable.screenshot,
                        R.drawable.screenshot, R.drawable.screenshot,
                        R.drawable.screenshot, R.drawable.screenshot}
        };
